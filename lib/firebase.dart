...
Future<void> userSetup(String username, String email) async {
  ...
  List<double> recreationAvgTime = List.filled(50, 0, growable: true);
  List<double> fnbAvgTime = List.filled(50, 0, growable: true);
  List<int> recreationSeen = List.filled(50, 0, growable: true);
  List<int> fnbSeen = List.filled(50, 0, growable: true);
