  ...
  Widget build(BuildContext context) {
    return Center(
      child: InkWell(
          child: Stack(
              children: [
                SizedBox(
                  ...
                  child: ClipRRect(
                    child: Opacity(
                      child: Image.network(widget.imgURLs[0], fit: BoxFit.cover), opacity: 0.3,), borderRadius: BorderRadius.circular(10.0),),
                ),
                Positioned.fill(
                  child: Align(
          ...
          onTap: () {
            Navigator.push(context, MaterialPageRoute(builder: (context) => ExtraInfoPage(imgURLs: widget.imgURLs, name: widget.name, description: widget.description, address: widget.address, imageURL_360: widget.imageURL_360),),);
          }
      ),
    );
  }
