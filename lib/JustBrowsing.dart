...
class JustBrowsing extends StatefulWidget {
  ...
  @override
  _JustBrowsingState createState() => _JustBrowsingState();
}
                    ...
                    return Swipable(
                        ...
                        onSwipeDown: (finalPosition) async {
                          if (isLoggedIn()) {
                            ...
                            updateAvgTimeSeen(
                                category, finalList[i]['name'], time);
                            stopwatch.reset();
                            stopwatch.start();
                            ...
                            final List<bool> isSelected =
                                justBrowsingKey.currentState!.isSelected;
                        ...
                        children: [
                          ...
                          Text.rich(
                            TextSpan(
                                ...
                                children: <TextSpan>[
                                  TextSpan(text: "This screen provides "),
                                  TextSpan(
                          ...
                          Text.rich(
                            TextSpan(
                                ...
                                children: <TextSpan>[
                                  TextSpan(
                                      text: "when 360-view is disabled",
                                      style: GoogleFonts.delius(
                          ...
                          Text.rich(
                            TextSpan(
                                ...
                                children: <TextSpan>[
                                  ...
                                  TextSpan(
                                      text: "not suited to your preferences",
                                      style: GoogleFonts.delius(
                                          color: Colors.pinkAccent)),
                                  TextSpan(text: "."),
                                ]),
                                ...
                                children: <TextSpan>[
                                  ...
                                  TextSpan(
                                      ...
                                      style: GoogleFonts.delius(
                                          color: Colors.pinkAccent)),
                                  TextSpan(
                                      text: "to the bookmark(s) selected."),
                                ]),
                          ),
                          Container(height: 5),
                          Text.rich(
...
Future<void> updateAvgTimeSeen(
    String category, String locationName, double time) async {
  String uid = await getCurrentUID();
...
Future<List<QueryDocumentSnapshot>> getAllLocations() async {
  QuerySnapshot qsSponsored =
      await FirebaseFirestore.instance.collection('sponsored').get();
  List<QueryDocumentSnapshot> sponsoredList = qsSponsored.docs.toList();

  QuerySnapshot qsRecreation =
      await FirebaseFirestore.instance.collection('recreation').get();

  List<QueryDocumentSnapshot> recreationDocs = qsRecreation.docs
      .where((d) => checkDuplicates(d['name'], sponsoredList))
      .toList();

  QuerySnapshot qsFnb =
      await FirebaseFirestore.instance.collection('fnb').get();

  List<QueryDocumentSnapshot> fnbDocs = qsFnb.docs
      .where((d) => checkDuplicates(d['name'], sponsoredList))
      .toList();
